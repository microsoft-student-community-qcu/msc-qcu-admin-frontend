...
3. This file will be used by the human developer to copy-paste into their GitHub Pull Request comment, so format it nicely with markdown lists, bold text for file names, and a brief explanation of _why_ the changes were made.

---
name: no-emojis
description: Use when writing commit messages, PR summaries, documentation, or chat responses
---

# No Emojis Allowed

This repository has a strict **NO EMOJIS ALLOWED** policy for all textual output.
...
- Any other Unicode emoji

**All of these mean: Remove the emoji immediately.**

    ...
    <div className="min-h-screen w-full relative flex items-center justify-center bg-muted overflow-hidden">
      ...
      <motion.div
        ...
        className={cn(
          ...
          stage === 0 ? "w-full max-w-[440px] h-[360px] shadow-64" : "w-screen h-screen max-w-none"
        )}
      >
        <div className={cn("flex-1 transition-opacity duration-500", stage === 2 ? "opacity-100" : "opacity-0")}>
          {stage === 2 && (
            <motion.div 

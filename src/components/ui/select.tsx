...
import { ChevronDownRegular, CheckmarkRegular, ChevronUpRegular } from "@fluentui/react-icons";
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={<ChevronDownRegular className="pointer-events-none size-4 text-muted-foreground" />}
      />
    </SelectPrimitive.Trigger>
  );
}
...
function SelectItem({ className, children, ...props }: SelectPrimitive.Item.Props) {
  return (
    ...
    >
      ...
      >
        <CheckmarkRegular className="pointer-events-none" />
      </SelectPrimitive.ItemIndicator>
    </SelectPrimitive.Item>
  );
}

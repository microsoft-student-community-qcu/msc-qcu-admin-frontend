...
export const LoginForm: React.FC = () => {
  ...
  return (
    <div
      ref={cardRef}
      className="relative z-10 w-full max-w-[440px] h-[320px] bg-background shadow-64 p-size320 md:p-size480 transition-all flex flex-col justify-between overflow-hidden"
    >
      {/* Top Indeterminate Progress Bar */}
      {isSubmitting && (
        <div className="absolute top-0 left-0 right-0 h-1 bg-muted overflow-hidden z-20">
          <div className="absolute top-0 bottom-0 bg-primary animate-fluent-progress-1" />
          <div className="absolute top-0 bottom-0 bg-primary animate-fluent-progress-2" />
        </div>
      )}

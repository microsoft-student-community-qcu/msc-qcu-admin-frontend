...
export function EventAttendeesModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-6xl w-[95vw] max-h-[92vh] p-0 flex flex-col bg-card rounded-none shadow-28 border border-border overflow-hidden">
        {/* Header */}
        <DialogHeader className="p-size240 border-b border-border/60 bg-muted/10 shrink-0">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {event.registrationOpen ? (
                <Badge
                  variant="outline"
                  className="border-emerald-500/40 text-emerald-700 dark:text-emerald-300 bg-emerald-500/10 text-xs font-medium rounded-none"
                >
                  Registration Open
                </Badge>
              ) : (
            ...
            <DialogTitle className="text-xl font-bold text-foreground line-clamp-1">
              {event.title}
            </DialogTitle>

            <DialogDescription className="flex flex-wrap items-center gap-x-6 gap-y-1.5 text-xs text-muted-foreground pt-0.5">
        ...
        >
          <div className="px-size240 pt-size120 border-b border-border/60 bg-muted/5 flex items-center justify-between shrink-0">
            <TabsList className="bg-transparent h-10 p-0 gap-2 rounded-none border-0">
              ...
              >
                Attendees & Roster ({registrations.length})
              </TabsTrigger>
              <TabsTrigger
                value="details"
                className="h-10 px-4 text-sm font-semibold rounded-none border-0 shadow-none data-active:bg-sidebar-accent data-active:text-sidebar-accent-foreground after:hidden cursor-pointer"
          ...
          <TabsContent value="attendees" className="flex-1 flex flex-col min-h-0 m-0 p-0">
            ...
            <div className="p-size160 border-b border-border/60 bg-muted/5 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-size160 shrink-0">
              ...
              <Table>
                <TableHeader className="sticky top-0 z-10 bg-muted/50 border-b border-border/60 shadow-1">
                  <TableRow className="hover:bg-transparent">
                    ...
                    <TableHead className="w-[180px] text-xs font-semibold text-muted-foreground uppercase tracking-wider">
                      Student ID
                    </TableHead>
                    <TableHead className="w-[180px] text-xs font-semibold text-muted-foreground uppercase tracking-wider">
                      Status
                ...
                <TableBody>
                  {isLoading ? (
                    ...
                    <TableRow className="hover:bg-transparent cursor-default border-0">
                      <TableCell colSpan={5} className="h-56 text-center text-muted-foreground text-xs">
                        Failed to load event registrations. Please check your connection.
                      </TableCell>
                    </TableRow>
                        ...
                        <div className="flex flex-col items-center justify-center gap-2">
                          ...
                          <p className="text-xs text-muted-foreground max-w-sm">
                            {search || status !== "ALL"
                              ...
                              : "No registrations have been received for this event yet."}
                          </p>
                        </div>
                      </TableCell>
                    </TableRow>
            ...
            <div className="p-size200 border border-border/60 bg-muted/5 flex flex-col gap-3 text-xs">
              <div className="flex items-center justify-between border-b border-border/30 pb-2.5">
                ...
                <span className="font-semibold text-foreground text-sm">
                  {event.venue || "MSC Innovation Hub"}
                </span>
              </div>
              <div className="flex items-center justify-between border-b border-border/30 pb-2.5">

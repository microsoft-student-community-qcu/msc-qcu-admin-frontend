...
Global folders are reserved strictly for logic, types, and services that cut across _multiple_ distinct feature domains (e.g., both the HR feature and the Logistics feature require it).
